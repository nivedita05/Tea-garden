...
#import frappe
#import unittest
#mport frappe.defaults
#rom frappe.test_runner import make_test_records

#est_records = frappe.get_test_records('Daily Green Leaf')

#lass TestDailyGreenLeaf(unittest.TestCase):
...
#ef create_daily_green_leaf(**args):
#dgl = frappe.new_doc("Daily Green Leaf")
#rgs = frappe._dict(args)
#if dgl.date:
#	dgl.date = args.date
